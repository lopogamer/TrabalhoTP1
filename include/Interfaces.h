...
public:
    ...
    /// @param codigo Código do Destino ao qual a Hospedagen ira pertencer.
    /// @return true se a hospedagem foi criada com sucesso, false caso contrário.
    virtual bool criarHospedagem(const Hospedagem, const Codigo) = 0;
    ...
    /// @param codigo Código da viagem à qual o destino pertencerá.
    ...
    /// @param codigo Código do destino ao qual a atividade pertencerá.
    /// @return true se a atividade foi criada com sucesso, false caso contrário.
    virtual bool criarAtividade(const Atividade, const Codigo) = 0;
